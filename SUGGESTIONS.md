...
**6 engine items and 4 documentation items**, three engine items and one documentation
item done so far, and a fourth engine item begun. It is written where
...
| The lighthouse handover — a lighthouse at dusk, 171 of 300, `paintings/Claude/lighthouse_handover/`, the first painting against 0.6.0, from the package in a sandbox | **3 open** | **3 open** |
