...
print(s.export("paintings/lighthouse_greenhouse/fable/painting.png"))
print(s.timelapse_gif("paintings/lighthouse_greenhouse/fable/painting.gif", fps=6.0, every=2, scale=512))
