...
s = Session(900, 600, ground="toned_grey", seed=7, out_dir="out_ex7")
...
print("wide :", s.rehearse(plan, region="C3:F6"))
print("liner:", s.rehearse([dict(plan[0], size=0.03, brush="liner")], region="C3:F6"))
s.stroke(**plan[0])
