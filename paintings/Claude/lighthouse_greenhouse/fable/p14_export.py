...
print(s.export("paintings/Claude/lighthouse_greenhouse/fable/painting.png"))
print(s.timelapse_gif("paintings/Claude/lighthouse_greenhouse/fable/painting.gif", fps=6.0, every=2, scale=512))
