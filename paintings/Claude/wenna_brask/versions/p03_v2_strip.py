...
def lay_neck():
    s.block_in(neck, "flat", "skin_shade", size=0.04, density=1.0, solid=True, direction=95,
...
def lay_face():
    ...
    s.block_in(face_mid, "flat", "skin_mid", size=0.02, density=1.0, solid=True,
               direction=[(0.50, 0.19), (0.53, 0.43)], edge="hard", clip=face, opacity=1.0,
               pressure="even", note="subject")
    s.block_in(face_lit, "flat", "skin_lit", size=0.02, density=1.0, solid=True,
               direction=[(0.52, 0.19), (0.58, 0.32)], edge="hard", clip=face, opacity=1.0,
               pressure="even", note="subject")
