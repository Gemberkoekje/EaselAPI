...
p["under_eye"] = p.at_value(p.mix("skin_mid", "ultramarine", 0.15), 0.40)
...
def lay_sockets():
    ...
    s.stroke([P(346, 300), P(360, 303), P(374, 300)], "round_soft", "under_eye", size=0.010,
             opacity=0.55, pressure=[0.3, 1.0, 0.4], **F)
...
def lay_nose():
    ...
    s.stroke([P(422, 306), P(426, 326), P(428, 346)], "round_soft", "cast", size=0.018,
             opacity=0.65, pressure=[0.3, 1.0, 0.6], **F)
...
def lay_modelling():
    ...
    s.stroke([P(362, 322), P(378, 344), P(396, 366)], "round_soft", "skin_mid", size=0.022,
             opacity=0.45, pressure=[0.4, 1.0, 0.5], **F)
