...
p["kerchief_shade"] = p.at_value(p.mix_many(["burnt_umber", "alizarin", "ultramarine", "titanium_white"], [2, 1, 1, 0.3]), 0.19)
p["neck"] = p.at_value(p.mix_many(["burnt_sienna", "burnt_umber", "ultramarine", "titanium_white"], [3, 3, 1, 0.5]), 0.21)
...
face = poly_t([(372, 205), (384, 212), (393, 228), (398, 245), (404, 258), (400, 268),
               ...
               (362, 216)], "face")
# Turned toward the lamp, the whole front of the face takes the light: the terminator runs
# down past the near eye's outer corner and the near cheekbone to the jaw, and only the side
# of the face beside the kerchief, and the jaw, turn away into shadow.
terminator = [(376, 210), (366, 236), (356, 262), (348, 288), (344, 312), (346, 338),
              (352, 364), (360, 392), (372, 418), (386, 436)]
face_lit = poly([(393.6, 186.7), (409.2, 195.8), (420.9, 216.6), (427.4, 238.7), (435.2, 255.6),
                 ...
                 (417, 440.2), (393.6, 437.6)] + terminator[::-1], "face lit")
face_mid = poly(terminator + [(370, 432), (356, 414), (344, 390), (336, 362), (330, 334),
                              (332, 306), (340, 280), (352, 250), (364, 222)], "face mid")
...
fist = poly([(358, 492), (366, 474), (384, 466), (404, 460), (424, 462), (444, 457),
             (462, 462), (478, 472), (484, 492), (480, 516), (470, 536), (448, 548),
             (418, 550), (390, 545), (370, 532), (360, 514)], "fist")
fist_top = poly([(366, 474), (384, 466), (404, 460), (424, 462), (444, 457), (462, 462),
                 (478, 472), (484, 490), (470, 488), (448, 486), (426, 488), (404, 490),
                 (384, 490), (370, 488)], "knuckles")
fist_front = poly([(370, 488), (384, 490), (404, 490), (426, 488), (448, 486), (470, 488),
                   (484, 490), (480, 514), (470, 532), (446, 530), (420, 526), (396, 520),
                   (378, 510)], "back of the hand")
