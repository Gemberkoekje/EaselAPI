...
body = polygon([
    ...
    (0.315, 0.330), (0.345, 0.305), (0.375, 0.290), (0.400, 0.286),      # the horn, curving back
    (0.372, 0.308), (0.350, 0.325),
    ...
    (0.555, 0.665), (0.540, 0.625), (0.490, 0.640), (0.430, 0.650),      # shin, knee, belly
    (0.392, 0.630), (0.372, 0.665), (0.370, 0.700), (0.395, 0.715),      # elbow, forearm back
    (0.400, 0.748)], name="gargoyle")
wing = polygon([(0.415, 0.395), (0.430, 0.300), (0.455, 0.200), (0.470, 0.120), (0.462, 0.092),
                (0.482, 0.108), (0.550, 0.058), (0.565, 0.150), (0.632, 0.118), (0.595, 0.225),
                (0.667, 0.250), (0.600, 0.320), (0.642, 0.372), (0.575, 0.410), (0.555, 0.430),
