...
8. **M8 — MCP server**, only if everything above is solid. One tool per CLI verb, plus `look`, `preview` and `compare` returning their images inline.
