...
a box, which is right for a wall, a band of floor, a panel of ceiling — and wrong for
...
prints the same ones. Lay large quiet masses — a wall, a door, a tabletop, a coat —
...
beside a face lands on the face, a band of carpet blocked in under a cabinet buries
...
band_at(0.42)        # a thin band at that height
...
import them: `from easel import Session, Region, region, cell, span, band_at,
