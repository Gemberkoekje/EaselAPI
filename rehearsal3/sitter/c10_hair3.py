# Pass 10: rehearsal C — graded strands with a bristle, then paint the winner.
...
SIZES = [0.052, 0.044, 0.060, 0.054, 0.064, 0.048, 0.064, 0.070, 0.068, 0.074,
         0.068, 0.058]
COLS = ["h_c", "h_c", "h_a", "h_a", "h_d", "h_c", "h_a", "h_d", "h_a", "h_d",
        "h_b", "h_b"]
...
plan = [{"points": pts, "brush": "bristle", "color": c, "size": sz,
         "load": 1.0, "pressure": pr}
        for pts, sz, c, pr in zip(MASS, SIZES, COLS, PRESS)]
plan += [{"points": pts, "brush": "bristle", "color": c, "size": sz,
          "load": 1.0, "pressure": "taper"} for pts, c, sz in LIT]

print("C graded bristle:", s.rehearse(plan, reference=REF, region=span("D1", "G5")))
